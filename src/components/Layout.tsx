          ...
          <nav className="flex-1">
            ...
            {isManager && (
              <>
                ...
                <SectionHeader>Master Configuration</SectionHeader>
                <NavItem view={ViewState.ADMIN_QUESTS} icon={GitBranch} label="Quest Factory" />
                <NavItem view={ViewState.ADMIN_TASK_CONFIG} icon={Settings} label="Task Logic" />
              </>
            )}
          </nav>
