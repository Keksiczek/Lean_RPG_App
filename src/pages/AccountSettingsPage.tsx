                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className={`p-3 rounded-lg border-2 text-sm font-medium transition-all ${language === 'en' ? 'border-red-600 bg-red-50 text-red-700' : 'border-gray-200 hover:border-gray-300'
                                }`}
                        >
                            English
                        </button>
                        <button
                            ...
                            className={`p-3 rounded-lg border-2 text-sm font-medium transition-all ${language === 'cs' ? 'border-red-600 bg-red-50 text-red-700' : 'border-gray-200 hover:border-gray-300'
                                }`}
                        >
                            Čeština
                        </button>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            type="password"
                            placeholder="AIzaSy..."
                            defaultValue={localStorage.getItem('lean_rpg_api_key') || ''}
                            onChange={(e) => localStorage.setItem('lean_rpg_api_key', e.target.value)}
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 outline-none font-mono text-sm"
                        />
                        <p className="text-xs text-gray-500 mt-2">
                            Stored locally in your browser. Get one at <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Google AI Studio</a>.
                        </p>
                    </div>
                </div>
